          ...
          <Carousel.Item key={product.id}>
            <div className="carousel-item-container">
              <div className="carousel-text">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quisquam, hic, praesentium.</p>
              ...
              <div className="carousel-image-container">
                ...
                <img src={product.img} alt={product.title} className="carousel-image" />
                {index < products.length - 1 && (
                  <img src={products[index + 1].img} alt={products[index + 1].title} className="carousel-image-small" />
                )}
              </div>
            </div>
          </Carousel.Item>
